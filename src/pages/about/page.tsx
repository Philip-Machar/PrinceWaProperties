          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-6 text-foreground-500 font-light leading-relaxed text-base md:text-lg">
                <p>
                  Prince Wa Properties began with a singular vision: to elevate the Kenyan real estate experience by introducing unprecedented levels of transparency, sophistication, and personalized service.
                </p>
                <p>
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="relative aspect-[4/5] md:aspect-square rounded-[2.5rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] group">
                <img
                  ...
                  alt="Prince Wa Properties Legacy"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div>
              ...
              <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8">
                The Vision <span className="italic font-light text-primary-400">Behind Prince </span>
              </h2>
              ...
              <p className="text-white/60 leading-relaxed font-light mb-10 text-sm md:text-base">
                We established Prince Wa Properties to transform this experience. By combining deep local expertise with a commitment to integrity, we ensure that every family and investor we serve can navigate the property market with absolute confidence. Our team works tirelessly to demystify real estate, offering honest valuations, clear communication, and unwavering support at every step.
              </p>
            ...
            <div className="relative">
              <div className="relative aspect-[3/4] md:aspect-square rounded-[3rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.3)] group">
                ...
                <img
                  ...
                  alt="Prince Wa Properties Founder - Peter Njoroge"
