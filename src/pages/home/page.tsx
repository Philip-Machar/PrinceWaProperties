...
export default function Home() {
  // Define Prince Wa Properties as a local real estate business to Google
  ...
  return (
    <div className="min-h-screen bg-background-50">
      <SEO 
        title="Prince Wa Properties | Luxury Real Estate in Nairobi (Karen, Runda, Westlands, Kilimani, Lavington)"
