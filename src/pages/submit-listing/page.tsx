          ...
          {status === 'success' ? (
            <div className="bg-card rounded-2xl p-10 border border-background-200 text-center shadow-sm">
              ...
              <p className="text-sm text-foreground-500 mb-6">
                Thank you for choosing Prince Wa Properties. Our team will review your property and contact you within 24 hours to verify the details before publishing.
              </p>
              <button
