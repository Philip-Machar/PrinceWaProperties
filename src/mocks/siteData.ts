...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: 'With over 15 years in Kenyan real estate, Peter founded Prince Wa Properties with a vision to transform property transactions through transparency and client-first service.',
  },
  {
    id: 'tm2',
    name: 'Faith Wambui',
...
export const timelineItems: TimelineItem[] = [
  {
    ...
    description: 'Prince Wa Properties was established with a vision to transform the real estate experience in Kenya.',
  },
  {
    year: '2013',
...
export const faqItems: FaqItem[] = [
  ...
  {
    question: 'Can I list my property with Prince Wa Properties?',
...
export const offices: Office[] = [
  {
    ...
    phone: '+254 757 344 593',
    email: 'info@Prince homes.com',
    isHQ: true,
  },
];